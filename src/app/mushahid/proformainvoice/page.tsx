...
function MushahidProformaInvoicePageContent() {
    ...
    // Main flow: Save invoice -> Generate Proforma PDF
    const handleGeneratePdfAndSave = async () => {
        ...
        try {
            // 1) Save invoice (using standard save API)
            ...
            console.log("Invoice saved (Mushahid):", saveResult);
            ...
            const generateResponse = await fetch(
                "/api/mushahidgenerateinvoiceproformapdff",
                { method: "GET" }
            );
        ...
        <div className="min-h-screen bg-gray-100 p-4 sm:p-6 md:p-8">
            ...
            <header className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between mb-8">
                <h1 className="text-3xl font-extrabold text-gray-900">
                    Create Proforma Invoice for Mushahid Khan
                </h1>
                <span className="text-sm text-gray-500">
                    Fill client & items, then generate a professional proforma PDF.
                </span>
            </header>
            ...
            <div className="max-w-5xl mx-auto space-y-8 lg:space-y-10">
                ...
                {message && (
                    <div
                        className={`mt-4 p-4 rounded-md text-center text-base sm:text-lg ${message.startsWith("Error")
...
export default function MushahidProformaInvoicePage() {
    return (
        <PasswordProtection>
            <MushahidProformaInvoicePageContent />
        </PasswordProtection>
    );
}
