...
export default function MustakGstPage() {
  return (
    <div className="container mx-auto py-12 px-4 min-h-[calc(100vh-250px)]">
      <h1 className="text-4xl font-bold text-gray-900 mb-6 text-center">Mustak Khan - GST Details</h1>
      <p className="text-lg text-gray-700 mb-8 text-center max-w-2xl mx-auto">
        This page provides an overview of GST filings and related documents for Mustak Khan.
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-8">
        ...
        <ul className="space-y-4">
          <li className="border-b border-gray-200 pb-4 last:border-b-0">
            ...
            <p className="text-gray-600">Period: July-Sept 2023 | Status: Filed | Date: 2023-10-20</p>
          ...
          <li className="border-b border-gray-200 pb-4 last:border-b-0">
            ...
            <p className="text-gray-600">Period: April-June 2023 | Status: Filed | Date: 2023-07-20</p>
            <Link href="#" className="text-orange-500 hover:underline text-sm">Download Report</Link>
          </li>
        </ul>
      </div>
